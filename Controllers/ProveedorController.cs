    ...
    public class ProveedorController: ControllerBase
    {
        ...
        public IActionResult InsertProveedor([FromBody] InsertProveedorModel req )
        {
            ...
            try
            {
                ...
                objectResponse.message = _ProveedorService.InsertProveedor(req);
        ...
        {
            var objectResponse = Helper.GetStructResponse();
            var resultado = _ProveedorService.GetProveedor();
        ...
        public IActionResult UpdateProveedor([FromBody] UpdateProveedorModel req )
        {
            ...
            try
            {
                objectResponse.StatusCode = (int)HttpStatusCode.OK;
                objectResponse.success = true;
                objectResponse.message = _ProveedorService.UpdateProveedor(req);
